...
Koch~et~al.~\cite{edler14}, exploits the structural similarity among functions.
...
%limitations.
In the next section, we show examples where the existing techniques fail to
merge the functions and how we can solve them.
