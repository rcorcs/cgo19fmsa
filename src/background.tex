...
Specifically, we describe both the state-of-the-art~\cite{edler14} and the
technique offered by major compilers~\cite{llvm-fm,livska14}.
%e.g., GCC and LLVM~\cite{llvm-fm,livska14}.

The function merging optimization currently offered by GCC and LLVM is
only able to merge identical functions.
