...
%calls are replaced by a call to the merged function.
Two of the key facts that prohibit the complete removal of the original functions
are the existance of indirect calls or when they are available for
external linkage.
...
unnecessary.
In the case void types, we can just return \textit{undefined} values since they
...
%The second pass over the aligned sequence updates
