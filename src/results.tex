...
mechanism based on the fingerprint similarity.
However, this difference does not change significantly the final code size reduction,
as it is also influenced by the size of the functions being merged, and not only
the number of merged functions.
