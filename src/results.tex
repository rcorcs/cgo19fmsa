...
\begin{figure}[t]
  \centering
  %\includegraphics[width=0.48\linewidth]{figs/obj-intel-n1-prof.pdf}
  %\includegraphics[width=0.48\linewidth]{figs/runtime-intel-n1-prof.pdf}
  \includegraphics[width=0.8\linewidth]{figs/profiling-results.pdf}
  \caption{Profile-guided function merging.}
