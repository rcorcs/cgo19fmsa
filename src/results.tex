...
Figure~\ref{fig:opt-pipeline} shows an overview the compilation pipeline used
...
due to the use of templating. %, as exemplified in Figure~\ref{fig:identical-example}.
...
that the functions \text{quantum\_gate1} is involved in a merge operation with
